    ...
    <div>
      ...
      <header>
        <div className="container header__container">
          ...
          <div className="header__right" id="spline-container">
            <SplineViewer url="https://prod.spline.design/e7fMPi34Xpt4idpF/scene.splinecode" />
          </div>
        </div>
      </header>
      ...
      <section data-aos="fade-up" className="container presentation-section">
        ...
        <div className="presentation-image">
          <img
            src="assets/Art for Synaps/Jellyfish - About us.png"
      ...
      <section data-aos="fade-up" className="card-section">
        <div className="card">
          ...
          <div className="card-content">
            <img
              src="assets/Icons For Synaps/Main Icons/rocket.png"
              alt="Mission Icon"
            />
        ...
        <div className="card">
          ...
          <div className="card-content">
            <img
              src="assets/Icons For Synaps/Main Icons/binoculars.png"
              alt="Vision Icon"
            />
        ...
        <div className="card">
          ...
          <div className="card-content">
            <img
              src="assets/Icons For Synaps/Main Icons/values.png"
              alt="Values Icon"
            />
